...
public:
    ...
    std::pair<std::vector<int>, int> calculate_route_(int location, int destination);
    std::pair<std::vector<Neighbour*>, int> calculate_route(int location, int destination);
